<template>
  <div>
    <el-dialog title="发布" :visible.sync="$parent.publishPopVisible" width="50%">
      ...
      <el-input v-model="publicUrl" readonly="readonly"> </el-input>
      <span slot="footer">
        <el-button type="primary" @click="$parent.publishPopVisible = false">确 定</el-button>
      </span>
    </el-dialog>
    <div class="edit-view" tabindex="0" @keydown.space.prevent="handleSpaceDown" @keyup.space.prevent="handleSpaceUp" @click.self="handleActivated(-1)">
